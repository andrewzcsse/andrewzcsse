...
title: Sprite Animation Practice
description: Practice with animating sprites in preparation for game project
toc: true
comments: false
layout: post
type: hacks
...
<body>
    <div>
        <canvas id="spriteContainer"> <!-- Within the base div is a canvas. An HTML canvas is used only for graphics. It allows the user to access some basic functions related to the image created on the canvas (including animation) -->
            <img id="BlueSprite" src="../../../images/blueboy.png">  // change sprite here
        </canvas>
...
<script>
    ...
    window.addEventListener('load', function () {
        ...
        class Dog {
            constructor() {
                this.image = document.getElementById("BlueSprite");
                this.x = 0;
                this.y = 0;
                this.minFrame = 0;
